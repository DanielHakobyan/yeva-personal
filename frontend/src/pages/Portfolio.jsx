...
const Portfolio = () => {
  ...
  return (
    ...
    >
      <h1 className="text-4xl md:text-6xl font-display font-bold mb-16 tracking-tight">Studio</h1>
              ...
              <Link to={`/portfolio/${project._id}`} className="group block">
                <div className="relative overflow-hidden rounded-2xl aspect-[4/5] mb-6">
                  ...
                  <div className="absolute bottom-0 left-0 p-6 translate-y-4 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-500">
                    <span className="text-white text-sm tracking-widest uppercase">View Project</span>
                  </div>
                </div>
                <h2 className="text-2xl font-display font-bold mb-2 group-hover:text-accent transition-colors">{project.title}</h2>
